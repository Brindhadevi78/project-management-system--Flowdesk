...
export default function Settings() {
  ...
  const exportData = () => {
    ...
    a.href = url;
    a.download = `flowdesk-backup-${Date.now()}.json`;
    a.click();
      ...
      <div className="p-8 flex-1 overflow-y-auto w-full max-w-3xl mx-auto">
        ...
        <Section title="Data & Storage">
          <div className="flex items-center justify-between">
            ...
            <button onClick={exportData} className="px-4 py-2 bg-blue-100 text-blue-600 font-bold text-sm rounded-xl hover:bg-blue-200 transition-colors flex items-center gap-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <button onClick={clearCache} className="px-4 py-2 bg-yellow-100 text-yellow-600 font-bold text-sm rounded-xl hover:bg-yellow-200 transition-colors flex items-center gap-2">
        ...
        <Section title="Danger Zone">
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => setConfirmDelete(true)} className="px-4 py-2 bg-red-100 text-red-600 font-bold text-sm rounded-xl hover:bg-red-200 transition-colors flex items-center gap-2">
      ...
      {confirmDelete && (
        <div className="absolute inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl text-center">
            ...
            <p className="text-slate-400 text-sm mb-6">This will permanently delete all your tasks and projects.</p>
